...
TARGET_KERNEL_SOURCE := kernel/samsung/j7popltespr
...
# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 19280144 # This is the maximum known partition size, but it can be higher, so we just omit it
